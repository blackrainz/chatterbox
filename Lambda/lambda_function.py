...
def validate_data(age, investment_amount, intent_request):
    ...
    """
    # Validate user is older than 0 and younger than 65
    if age is not None:
        age = parse_float(age)
        if age <= 0 or age >= 65:
            return build_validation_result(
                False,
                "age",
                "I'm sorry, we only serve users that are born and younger than 65."
            )  
...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you, {}, for your time and patience;
            our recommendation is that with a {} risk level you invest in {}
